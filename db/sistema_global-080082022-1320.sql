...
INSERT INTO `area_empresa` VALUES (1,'PROYECTOS INDUSTRIALES'),(2,'PROYECTOS TECNOLOGICOS'),(3,'INGENIERIA DE SOFTWARE /DATA SCIENCE');
...
INSERT INTO `cliente` VALUES (1,'86247400-7','Empresas Aqua Chile',1),(2,'99520820-2','Salmones de Chile',1),(3,'96545040-8','Productos del Mar Ventisqueros',1),(4,'76269877-3','Grupo Tecnología Spa',1),(5,'76495180-8','Procesadora Calbuco SPA',1),(6,'76261653-K','Pharmaq Fishteq',1),(7,'96633780-k','Mowi Chile S.A',1),(8,'77673760-7','Caleta Bay Export Spa.',1);
...
INSERT INTO `localizacion` VALUES (1,'localizacion 1'),(2,'localizacion 2');
...
INSERT INTO `menu` VALUES (1,'PROYECTOS','#','proyectos',1,1,1),(2,'PROYECTOS','#','proyectos',1,2,1);
...
INSERT INTO `mes` VALUES (1,'01','Enero',31),(2,'02','Febrero',28),(3,'03','Marzo',31),(4,'04','Abril',30),(5,'05','Mayo',31),(6,'06','Junio',30),(7,'07','Julio',31),(8,'08','Agosto',31),(9,'09','Septiembre',30),(10,'10','Octubre',31),(11,'11','Noviembre',30),(12,'12','Diciembre',31),(13,'PENDIENTE','PENDIENTE',0);
...
CREATE TABLE `proyecto` (
  ...
  CONSTRAINT `proyecto_ibfk_11` FOREIGN KEY (`id_clp_uf`) REFERENCES `clp_uf` (`id`),
...
INSERT INTO `representante` VALUES (1,NULL,NULL,NULL,'JORGE ','HIDALGO',3),(2,NULL,NULL,NULL,'ALEJANDRO','CARO',1),(3,NULL,NULL,NULL,'ALEJANDRO','CASTILLO',2),(4,NULL,NULL,NULL,'ROLANDO','ALVARADO',2),(5,NULL,NULL,NULL,'MANUEL','MEJIA',6),(6,NULL,NULL,NULL,'FELIPE','RIVEROS',7),(7,NULL,NULL,NULL,'Jorge Prieto','Fabián Mancilla',8);
...
INSERT INTO `servicio` VALUES (1,'Servicio 1',1,1),(2,'Servicio 2',2,2);
...
INSERT INTO `sub_menu` VALUES (1,'Lista de Proyectos','content-page.php','base',1),(2,'Crear Proyecto','content-page.php','crear-proyecto',1);
...
INSERT INTO `tipo_servicio` VALUES (1,'Tipo Servicio 1'),(2,'Tipo Servicio 2'),(3,'Tipo Servicio 3');
...
-- Dump completed on 2022-08-08 13:19:58
